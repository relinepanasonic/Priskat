...
buildGenerator('faith_devotions.csv', 'Faith', 'Iman', '043_seed_devotions_faith.sql', '043');
buildGenerator('family_devotions.csv', 'Family', 'Keluarga', '044_seed_devotions_family.sql', '044');
buildGenerator('forgiveness_devotions.csv', 'Forgiveness', 'Pengampunan', '045_seed_devotions_forgiveness.sql', '045');
