    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-brand-blue-50 to-brand-cream px-4 py-12">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-brand-gold text-brand-dark text-white font-bold text-lg">
            P
          </div>
          <h1 className="text-2xl font-bold text-brand-gold">PriskatCFM</h1>
        </div>
