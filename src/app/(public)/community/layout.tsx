...
const TABS = [
  ...
  { href: "/community/group", label: "Group", icon: UsersRound },
];
          ...
          {TABS.map(({ href, label, icon: Icon }) => {
            ...
            return (
              <Link
                key={href}
                href={href}
                className={`flex-1 flex flex-col items-center gap-1 py-3 text-[11px] font-bold tracking-wide transition-colors ${
