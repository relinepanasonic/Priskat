...
as $$
declare
  base_username text; final_username text; counter integer := 0;
begin
  ...
  insert into public.profiles(id, username, full_name, phone, role, angkatan, kota, camp_history, completed_modules)
  values (
    new.id,
    final_username,
